...
CONFIG={
 ...
 "mines":[
  {"x":0.16,"y":0.84,"distributions":[[0.2,0],[0,0]]},
  {"x":0.5,"y":0.84,"distributions":[[0.15,0],[0.1,0]]},
  {"x":0.84,"y":0.84,"distributions":[[0.2,0],[0.2,0]]},
  {"x":0.84,"y":0.5,"distributions":[[0.1,0],[0.15,0]]},
  {"x":0.84,"y":0.16,"distributions":[[0,0],[0.2,0]]}
 ]}
...
if __name__=='__main__':
 ...
 path=Path('/mnt/data/mo02_minecart/mo02_det_result.json'); path.write_text(json.dumps(out,indent=2))
